...
export class WUniqueFormat {
  ...
  public isTableFormatEqual(
    ...
    if (
      this.isNotEqual("subSeccion", source, modifiedProperty, modifiedValue, 8)
    ) {
      return false;
    }
    return true;
  ...
  public isSectionFormatEqual(
    ...
    if (
      this.isNotEqual("seccion", source, modifiedProperty, modifiedValue, 10)
    ) {
      return false;
    }
    return true;
