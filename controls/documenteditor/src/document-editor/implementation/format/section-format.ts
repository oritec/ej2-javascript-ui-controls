...
export class WSectionFormat {
  ...
  get seccion(): Object {
    return this.getPropertyValue("seccion") as Object;
  }
  set seccion(value: Object) {
    this.setPropertyValue("seccion", value);
  }
  ...
  private setPropertyValue(property: string, value: Object): void {
    ...
    if (isNullOrUndefined(this.uniqueSectionFormat)) {
      ...
      this.uniqueSectionFormat = WSectionFormat.uniqueSectionFormats.updateUniqueFormat(
  ...
  private initializeUniqueSectionFormat(
    ...
    let uniqueSectionFormatTemp: Dictionary<number, object> = new Dictionary<
      number,
      object
    >();
    ...
    // tslint:disable-next-line:max-line-length
    this.uniqueSectionFormat = WSectionFormat.uniqueSectionFormats.addUniqueFormat(
      uniqueSectionFormatTemp,
      WSectionFormat.uniqueFormatType
    );
  }
